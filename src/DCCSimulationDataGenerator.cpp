                                                       ...
                                                       SimulationChannelDescriptor** simulation_channel)
{
    ...
    while (mSerialSimulationData.GetCurrentSampleNumber() < adjusted_largest_sample_requested)
    {
        ...
        mSerialSimulationData.Transition();
        mSerialSimulationData.Advance((U64)mSimulationSampleRateHz * (100 - 14) /
                                      1000000); // -14 us ( = 4 us less than relaxed timing permits)
        Create1bit();
        Create1bit();
        mSerialSimulationData.Transition();
        mSerialSimulationData.Advance((U64)mSimulationSampleRateHz * (58 + 8) /
                                      1000000); // +8 us ( = 2 us more than relaxed timing permits)
        mSerialSimulationData.Transition();
